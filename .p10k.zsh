# Generated by Powerlevel10k configuration wizard on 2022-05-25 at 19:29 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold'
  ...
  typeset -g POWERLEVEL9K_AWS='aws|awless|terraform|pulumi|terragrunt'
